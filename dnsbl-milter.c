 ...
 * $Id$
 *
 * dnsbl-milter.c  by Haw Loeung <hloeung@users.sourceforge.net>
 *
 * Sendmail milter used to consult a list of DNS blacklists & whitelists to see
 * if messages from particular hosts should be accepted
 *
 */
